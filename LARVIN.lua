...
if hash or SudoBot(msg) or DevLARViNW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevLARViNW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLARViNW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLARViNW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLARViNW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬𝐁𝐎𝐘𝐊𝐀 𝐓𝐄𝐀𝐌
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[Channel LARViN](t.me/pvv_v) 
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[Information](t.me/BOBBW)
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/CCFRR)
≪━━━━━━𝘽𝙆━━━━━━≫
 ❃∫ ↬[orders LARViN](t.me/source_LARViN)
≪━━━━━━𝘽𝙆━━━━━━≫
...
if DevLARViNW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LARViNTEAM/Files_LARViN/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LARViNTEAM/Files_LARViN/master/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'LARViN')..') '
...
zh = https.request('https://rudi-dev.tk/Amir1/LARViN.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/LARViN.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/LARViN.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
